        ...
        <div :id="'collapse' + this.id" class="accordion-collapse collapse show" :aria-labelledby="'heading' + this.id">
            <div class="accordion-body">
                ...
                <div v-if="this.editing">
                    <textarea class="form-control" v-model="this.contentData" style="height: 80px;" />
                ...
                <div v-else>
                    ...
                    <button data-bs-toggle="modal" data-bs-target="#commentsModal">Reacties</button>
  ...
  <div class="modal-dialog" ref="modal">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="commentsModalLabel">{{this.title}}</h5>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="mb-3">
            ...
            <textarea class="form-control" id="message-text" style="height: 100px" v-model="this.newComment"></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" @click="addComment()">Reageer</button>
      </div>
    </div>
  </div>
</div>
...
<script>
import { deleteAnnouncement, editAnnouncement, addComment } from '@/services/ProjectService.js';
...
export default {
  ...
  methods: {
    ...
    saveEdit() {
        editAnnouncement(this.id, this.contentData);
        this.editing = false;
        this.$emit('reload');
    },
    addComment() {
        addComment(this.id, this.newComment) //TODO: add user id
