...
# def user_has_permission(user_id, permission_type, resource_type, resource_id=None):
...
#         if permission_type == "UPDATE ARCHIVE":
#             return permissions["may_archive_any_project"]
